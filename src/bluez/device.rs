...
pub trait OrgBluezDevice1 {
    ...
    fn sets(&self) -> Result<::std::collections::HashMap<dbus::Path<'static>, arg::PropMap>, dbus::Error>;
}
...
impl<'a, T: blocking::BlockingSender, C: ::std::ops::Deref<Target=T>> OrgBluezDevice1 for blocking::Proxy<'a, C> {
    ...
    fn bonded(&self) -> Result<bool, dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::get(self, "org.bluez.Device1", "Bonded")
    }
    ...
    fn wake_allowed(&self) -> Result<bool, dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::get(self, "org.bluez.Device1", "WakeAllowed")
    }

    fn sets(&self) -> Result<::std::collections::HashMap<dbus::Path<'static>, arg::PropMap>, dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::get(self, "org.bluez.Device1", "Sets")
    }
    ...
    fn set_wake_allowed(&self, value: bool) -> Result<(), dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::set(self, "org.bluez.Device1", "WakeAllowed", value)
    }
}
...
impl<'a, T: blocking::BlockingSender, C: ::std::ops::Deref<Target=T>> OrgBluezMediaControl1 for blocking::Proxy<'a, C> {
...
impl<'a, T: blocking::BlockingSender, C: ::std::ops::Deref<Target=T>> OrgBluezBattery1 for blocking::Proxy<'a, C> {
    ...
    fn source(&self) -> Result<String, dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::get(self, "org.bluez.Battery1", "Source")
    }
}
