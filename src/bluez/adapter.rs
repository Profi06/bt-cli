...
impl<'a, T: blocking::BlockingSender, C: ::std::ops::Deref<Target=T>> OrgBluezAdapter1 for blocking::Proxy<'a, C> {
    ...
    fn power_state(&self) -> Result<String, dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::get(self, "org.bluez.Adapter1", "PowerState")
    }
    ...
    fn roles(&self) -> Result<Vec<String>, dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::get(self, "org.bluez.Adapter1", "Roles")
    }

    fn experimental_features(&self) -> Result<Vec<String>, dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::get(self, "org.bluez.Adapter1", "ExperimentalFeatures")
    }

    fn manufacturer(&self) -> Result<u16, dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::get(self, "org.bluez.Adapter1", "Manufacturer")
    }

    fn version(&self) -> Result<u8, dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::get(self, "org.bluez.Adapter1", "Version")
    }
...
impl<'a, T: blocking::BlockingSender, C: ::std::ops::Deref<Target=T>> OrgBluezBatteryProviderManager1 for blocking::Proxy<'a, C> {

    fn register_battery_provider(&self, provider: dbus::Path) -> Result<(), dbus::Error> {
        self.method_call("org.bluez.BatteryProviderManager1", "RegisterBatteryProvider", (provider, ))
    }

    fn unregister_battery_provider(&self, provider: dbus::Path) -> Result<(), dbus::Error> {
        self.method_call("org.bluez.BatteryProviderManager1", "UnregisterBatteryProvider", (provider, ))
    }
}

pub trait OrgBluezGattManager1 {
    fn register_application(&self, application: dbus::Path, options: arg::PropMap) -> Result<(), dbus::Error>;
...
pub trait OrgBluezMedia1 {
    fn register_endpoint(&self, endpoint: dbus::Path, properties: arg::PropMap) -> Result<(), dbus::Error>;
    fn unregister_endpoint(&self, endpoint: dbus::Path) -> Result<(), dbus::Error>;
    fn register_player(&self, player: dbus::Path, properties: arg::PropMap) -> Result<(), dbus::Error>;
...
impl<'a, T: blocking::BlockingSender, C: ::std::ops::Deref<Target=T>> OrgBluezMedia1 for blocking::Proxy<'a, C> {
    ...
    fn supported_uuids(&self) -> Result<Vec<String>, dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::get(self, "org.bluez.Media1", "SupportedUUIDs")
    }
}
...
pub trait OrgBluezLEAdvertisingManager1 {
    fn register_advertisement(&self, advertisement: dbus::Path, options: arg::PropMap) -> Result<(), dbus::Error>;
...
impl<'a, T: blocking::BlockingSender, C: ::std::ops::Deref<Target=T>> OrgBluezLEAdvertisingManager1 for blocking::Proxy<'a, C> {
    ...
    fn supported_features(&self) -> Result<Vec<String>, dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::get(self, "org.bluez.LEAdvertisingManager1", "SupportedFeatures")
    }

    fn supported_capabilities(&self) -> Result<arg::PropMap, dbus::Error> {
        <Self as blocking::stdintf::org_freedesktop_dbus::Properties>::get(self, "org.bluez.LEAdvertisingManager1", "SupportedCapabilities")
    }
}
